<?php
// ------ Greek translated by jm  ------

// Login and Password errors
$strNoAccess          = "Access denied - Άρνηση πρόσβασης";
$strNoPassword        = "Δεν δώσατε κωδικό";
$strPwFalse           = "Λάθος κωδικός";
$strPwNotFound        = "No password was found in the database";
$strUserNotAllowed    = "Αυτός ο χρήστης δεν επιτρέπεται να δέι αυτήν την σελίδα";
$strUserNotExist      = "Ο χρήστης δέν υπάρχει";
...
$strJSHello           = "Επισκέπτης,\\n" . "Παρακάλω δώστε τα παρακάτω στοιχεία:";
$strLogin             = "Login - όνομα χρήστη";
$strLoginInterface    = "Είσοδος Χρήστη";
$strPassword          = "Password - κωδικός";
$strPoweredBy         = "powered by a modified version of ";
