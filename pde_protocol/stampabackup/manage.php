...
<body>
	<div id="wrapper">
        ...
        <ul id="mainNav">
        	...
        	<li><a href="backup.php">ΔΗΜΙΟΥΡΓΙΑ ΑΝΤΙΓΡΑΦΟΥ ΑΣΦΑΛΕΙΑΣ</a></li>
        	<li><a href="restore.php">ΕΠΑΝΑΦΟΡΑ</a></li>
        	<li class="logout"><a href="../logout_jon.php">LOGOUT</a></li>
        </ul>
        <!-- // #end mainNav -->
        ...
        <div id="containerHolder">
			<div id="container">
                ...
                <div id="main">
					...
					<h3>ΔΙΑΘΕΣΙΜΑ ΑΝΤΙΓΡΑΦΑ ΑΣΦΑΛΕΙΑΣ </h3>
...
while (false !== ($file = readdir($dir))) { 
	...
	// Print the cells
		print("<tr>\n");
		print("  <td>" .$date . " - ". $filenameboth . "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>\n");
		print("  <td class='action'><a href='restore.php?id=" .$backup_dir. $filenameboth . "' class='edit'>Restore</a>\n");
		print("<a href='".$backup_dir.$filenameboth . ".sql' class='view'>Download SQL</a>\n");
		if($create_files_backup){print("<a href='" .$backup_dir. $filenameboth . ".zip' class='view'>Download ZIP</a>\n");}
		if($allow_delete){print("<a href='delete.php?file=" . $backup_dir.$filenameboth . "' class='delete'>Delete</a></td>\n");}
		print("</tr>\n");
	} 
} 
?>
