...
$filess = $backup_dir.'dbbackup_' . date("Ymd_H-i") . $extname;
...
if($create_files_backup){
	...
	if ($v_list == 0) {
		die("Error : ".$archive->errorInfo(true));
      	...
      	// Print the message
	print('The backup has been created successfully. (filename : '.$filess.'.sql) <br />You can get <b>MySQL dump file</b> <a href="' . $filess . '.sql" class="view">here</a>.<br>' . "\n");
if($create_files_backup)	print('You can get <b>Backed-up files archive</b> <a href="' . $filess . '.zip" class="view">here</a>.<br>' . "\n");
?>
