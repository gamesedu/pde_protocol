<?php  
//backup_excel.php   //version 2.0 20120222 - Protocol Fork


//some simple security
if(!is_numeric($xro) || $xro<2010 || $xro >2030 ) {
exit();
}
if($tri_debug)echo "Inside";
if (empty($backup_excel_path)) $backup_excel_path="";
/* 
...
Change log:
2.0 Protocol fork -sorting dates/protocol numbers
1.0a : 
-Added UTF-8 support
-
*/
// load library
require_once $backup_excel_path.'php-excel.class.php';
...
//Run it like this :
backup_excel("localhost","john","john","pde_protocol_production",'protocol_entries',"backup_sql_/");
